...
public class SwaggerConfig {
    ...
    private static final Contact DEFAULT_CONTACT = new Contact("Hyunwoo Ryu",
            "https://github.com/uhanuu", "hwryu990927@gmail.com");

    private static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Awesome API Title", "DongDongJu", "1.0",
